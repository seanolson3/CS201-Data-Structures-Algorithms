...
public class Main {
    public static void main(String[] args) {
        ...
        int score = calculateScore(userGuessList, twoDArray);
        ...
        for (int i = 0; i < twoDArray[0].length; i++) {
            String state = twoDArray[0][i];
            String capital = twoDArray[1][i];
